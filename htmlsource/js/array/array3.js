...
console.log("망고의 포함여부 " + fruits.includes("망고"));
console.log("딸기의 index 찾기 " + fruits.indexOf("딸기"));
console.log("딸기의 포함여부 " + fruits.includes("딸기"));

console.log("30보다 큰 배열 " + array2.find((item) => item > 30));
console.log("30보다 큰 배열 인덱스" + array2.findIndex((item) => item > 30));
// map() : 새 배열로 리턴
